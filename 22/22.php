...
$url_path = str_replace('\\', '/', $url_path);
    ...
    $styles = $scss->compile('@import "22-styles.scss";');

    $css = fopen('css/22-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/22-styles.css" rel="stylesheet" type="text/css" />
